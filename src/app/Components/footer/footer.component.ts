...
export class FooterComponent implements OnInit {
  originalText = {
    ...
    Paragraph:
      'we are a pet shop online and we aim to offer our customers a variety of the latest Pet Products online. supplying you with high quality yet budget-friendly products. We offer all of this while providing excellent customer service and friendly support.',
  };
  ...
  translatedText = {
    ...
    Paragraph:
      ' نحن متجر للحيوانات الأليفة عبر الإنترنت ونهدف إلي أن نقدم لعملائنا مجموعة متنوعة من المنتجات , أحدث منتجات الحيوانات الأليفة علي الإنترنت , تزويدك بجودة عالية حتي الان منتجات صديقية للميزانية , نحن نقدم كل هذا مع تقديم ممتاز خدمة العملاء والدعم الودي ..',
  };
  isTranslated = false;
